          ...
          <nav class="navbar navbar-expand-lg">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
              ...
              <ul class="nav navbar-nav ml-auto mr-auto">
                ...
                <li class="nav-item"> <a class="nav-link" href="<?php echo base_url(); ?>index.php/Indexcontroller/studentl" >Student</a>
                </li>  
              </ul>
            </div> 
            <div class="dropdown"> 
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="POST" action="<?php echo base_url(); ?>index.php/Indexcontroller/login_doctor" name="form" id="form">
					...
					<div class="form-group">
						<button type="submit" name="submit" class="btn btn-primar btn-block btn-lg">Sign In</button>
					</div>
					<p class="hint-text"><a href="#">Forgot Password?</a></p>
				</form>
			</div>
