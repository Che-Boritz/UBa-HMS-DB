...
<!--== audioplayer -->
<link href="<?php echo base_url(); ?>assets/css/audioplayer/plyr.css" rel="stylesheet" type="text/css" />
...
<!--== slit-slider -->
<link href="<?php echo base_url(); ?>assets/css/slit-slider/slit-slider.css" rel="stylesheet" type="text/css" />

<!--== datepicker -->
<link href="<?php echo base_url(); ?>assets/css/date-picker/date-picker.css" rel="stylesheet" type="text/css" />
        ...
        <div class="col-lg-12">
          ...
          <nav class="navbar navbar-expand-lg">
            <a class="navbar-brand logo" href="index.html">
              <img id="logo-img" class="img-center" src="<?php echo base_url(); ?>images/logo.png" alt="">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
              ...
              <ul class="nav navbar-nav ml-auto mr-auto">
                ...
                <li class="nav-item"><a class="nav-link trigger-btn" href="<?php echo base_url(); ?>index.php/Indexcontroller/liste_student"  data-toggle="modal">Nurse</a>
                </li> 
                ...
                <li class="nav-item"> <a class="nav-link" href="<?php echo base_url(); ?>index.php/Indexcontroller/newstudent" >Student</a></li>
                  <li class="nav-item"> <a class="nav-link" href="<?php echo base_url(); ?>index.php/Indexcontroller/liste_student" >nursedashboard</a>
                </li>  
              </ul>
            </div> 
            <div class="dropdown"> 
                ...
                <ul class="dropdown-menu">  
                    <li  class="subNav"><a class="nav-link" href="<?php echo base_url(); ?>index.php/Indexcontroller/newstudent" >Student</a>
                    </li>  
  ...
  <div id="slider" class="sl-slider-wrapper">
    <div class="sl-slider">
      <div class="sl-slide sl-trans-elems" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
        <div class="sl-slide-inner" data-bg-img="<?php echo base_url(); ?>images/bg/01.jpg">
      ...
      <div class="sl-slide" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
        <div class="sl-slide-inner" data-bg-img="<?php echo base_url(); ?>images/bg/05.jpg" data-overlay="0">
          <div class="align-center">
            <div class="container">
      ...
      <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
        <div class="sl-slide-inner" data-bg-img="<?php echo base_url(); ?>images/bg/03.jpg">
          <div class="align-center">
            <div class="container">
  ...
  <div class="container bnr-form">
    <div class="row align-items-center">   
      <div class="col-lg-5 col-md-12">
        <img class="img-fluid" src="<?php echo base_url(); ?>images/about/00.png" alt="">
      </div>
      <div class="col-lg-7 col-md-12"> 
      <div class="col-lg-12 col-md-12">
          <img class="img-fluid" src="<?php echo base_url(); ?>images/logo-removebg-preview.png" alt="UBa HMS">
      </div> 
        ...
        <div class="owl-carousel owl-theme dark-service" data-items="3" data-md-items="2" data-sm-items="1" data-xs-items="1" data-margin="30" data-autoplay="true">
          <div class="item">
            <div class="service-item">
              <div class="service-<?php echo base_url(); ?>images">
                <img class="img-fluid" src="<?php echo base_url(); ?>images/service/01.jpg" alt="">
          ...
          <div class="item">
            <div class="service-item">
              <div class="service-images">
                <img class="img-fluid" src="<?php echo base_url(); ?>images/service/02.jpg" alt="">
          ...
          <div class="item">
            <div class="service-item">
              <div class="service-<?php echo base_url(); ?>images">
                <img class="img-fluid" src="<?php echo base_url(); ?>images/service/03.jpg" alt="">
          ...
          <div class="item">
            <div class="service-item">
              <div class="service-<?php echo base_url(); ?>images">
                <img class="img-fluid" src="<?php echo base_url(); ?>images/service/04.jpg" alt="">
          ...
          <div class="item">
            <div class="service-item">
              <div class="service-<?php echo base_url(); ?>images">
                <img class="img-fluid" src="<?php echo base_url(); ?>images/service/06.jpg" alt="">
                ...
                <div class="col-md-6">
                  <div class="testimonial-avatar box-shadow">
                    <div class="testimonial-img">
                      <img class="img-center w-100 radius" src="<?php echo base_url(); ?>images/testimonial/01.jpg" alt="">
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="testimonial">
              <div class="row align-items-center">
                <div class="col-md-6">
                  <div class="testimonial-avatar box-shadow">
                    <div class="testimonial-img">
                      <img class="img-center w-100 radius" src="<?php echo base_url(); ?>images/testimonial/02.jpg" alt="">
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
    ...
    <div class="row">
      <div class="col-md-12">
       <div class="owl-carousel owl-theme no-pb" data-items="5" data-md-items="4" data-sm-items="3" data-xs-items="1" data-margin="30" data-dots="false" data-autoplay="true">
          <div class="item">
            <img class="img-center" src="<?php echo base_url(); ?>images/client/01.png" alt="">
          </div>
          <div class="item">
            <img class="img-center" src="<?php echo base_url(); ?>images/client/02.png" alt="">
          </div>
          <div class="item">
            <img class="img-center" src="<?php echo base_url(); ?>images/client/03.png" alt="">
          </div>
          <div class="item">
            <img class="img-center" src="<?php echo base_url(); ?>images/client/04.png" alt="">
          </div>
          <div class="item">
            <img class="img-center" src="<?php echo base_url(); ?>images/client/05.png" alt="">
          </div>       
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6">
          <div class="footer-logo mb-3">
            <img id="footer-logo-img" class="img-center" src="<?php echo base_url(); ?>images/logo.png" alt="">
          </div>
...
<!--== audioplayer -->
<script src="<?php echo base_url(); ?>js/audioplayer/plyr.min.js"></script>
...
<!--== slit-slider -->
<script src="<?php echo base_url(); ?>js/slit-slider/jquery.ba-cond.min.js"></script>
<script src="<?php echo base_url(); ?>js/slit-slider/jquery.slitslider.js"></script>

<!--== jarallax -->
<script src="<?php echo base_url(); ?>js/jarallax/jarallax.min.js"></script> 

<!--== counter -->
<script src="<?php echo base_url(); ?>js/counter/counter.js"></script> 

<!--== skill -->
<script src="<?php echo base_url(); ?>js/skill/circle-progressbar.js"></script> 

<!--== countdown -->
<script src="<?php echo base_url(); ?>js/countdown/jquery.countdown.min.js"></script> 

<!--== isotope -->
<script src="<?php echo base_url(); ?>js/isotope/isotope.pkgd.min.js"></script> 

<!--== contact-form -->
<script src="<?php echo base_url(); ?>js/contact-form/contact-form.js"></script>

<!--== datepicker -->
<script src="<?php echo base_url(); ?>js/date-picker/date-picker.js"></script>

<!--== nice-select -->
<script src="<?php echo base_url(); ?>js/jquery.nice-select.js"></script>
