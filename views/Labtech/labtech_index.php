            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class=" waves-effect waves-dark" href="#" aria-expanded="false"><i class="fas fa-ambulance"></i><span class="hide-menu">   Outpatient </span></a>
                        </li>
                ...
                <div class="row" id="overVeiwSection"> 
                   <div class="col-md-6 col-lg-8">
                       <div class="col-lg-12">
                        <div class="card box-shadow">
                            <div class="card-body">
                                <h4 class="card-title">Incoming Patients</h4>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                  ...
                                                  <a href="<?php echo base_url('index.php/Indexcontroller/labtech_consultstudent/'.$id); ?>" class="none text-primary bold seize-1-0">
                                                    <b>consulter</b>
                                                  </a>
                                                </td>
                                            </tr>
                    ...
                    <div class="col-lg-12">
                        <div class="card box-shadow">
                            <div class="card-body">
                                <h4 class="card-title">Doctor Requesed</h4>
                                <div class="table-responsive">
                                    <table class="table color-table info-table">
                                        <thead>
                                            <tr>
                    ...
                    <div class="col-lg-12">
                        <div class="card box-shadow">
                            <div class="card-body">
                                <h4 class="card-title">Nurses Requesed</h4>
                                <div class="table-responsive">
                                    <table class="table color-table info-table">
                                        <thead>
                                            <tr>
